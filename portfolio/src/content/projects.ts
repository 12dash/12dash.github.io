...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Read the report (PDF)", href: "https://github.com/12dash/12dash.github.io/releases/download/assets-v1/fair-image-generation-report.pdf" },
    ],
    featured: true,
    sections: [
      {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Read the report (PDF)", href: "https://github.com/12dash/12dash.github.io/releases/download/assets-v1/coauthorship-network-report.pdf" },
    ],
    featured: true,
    stars: 22,
    sections: [
